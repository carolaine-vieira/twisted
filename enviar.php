...
// Mudar Aqui o e-mail
$email_envio = "s.carolaine.v@gmail.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "*yytz423dW"; // Senha do e-mail

$site_name = "Twisted"; // Nome do Site
$site_url = "www.twisted.com"; // URL do Site
